...
if (typeof window !== "undefined") {
  const mockApi = {
    ...
    fs: {
      ...
      saveLayoutDialog: vi.fn().mockResolvedValue(null),
      openLayoutDialog: vi.fn().mockResolvedValue(null),
      onMenuOpenLayout: vi.fn().mockReturnValue(() => {}),
      onMenuSaveLayout: vi.fn().mockReturnValue(() => {}),
      onMenuCloseLayout: vi.fn().mockReturnValue(() => {}),
      onMenuImport: vi.fn().mockReturnValue(() => {}),
      setLayoutMenuState: vi.fn(),
