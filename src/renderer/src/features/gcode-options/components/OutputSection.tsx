    ...
    <div className="flex flex-col gap-4 mt-2 mb-1">
      ...
      <label className="flex items-start gap-3 cursor-pointer select-none">
        ...
        <div>
          ...
          <div className="text-xs text-content-muted mt-0.5">
            Generate additional hatch-only files for each color group, allowing
            you to apply hatches with a separate tool/pen. Requires "Export one
            file per colour group" to be enabled.
          </div>
