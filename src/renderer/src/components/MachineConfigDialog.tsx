                ...
                >
                  ...
                  <Section title="Pen Commands">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <Field label="Pen down command">
                        <input
                          ...
                          className={inputCls + " font-mono"}
                          placeholder={
                            PEN_DEFAULTS[form.penType].penDownCommand
                          }
                        />
                      </Field>
                    ...
                    <p className="text-xs text-content-faint">
                      ...
                      travel begins. Both delays are ignored for stepper
                      profiles.
                    </p>
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <Field label="Host / IP">
                          <input
                            ...
                            onChange={(e) =>
                              changeConn({ host: e.target.value })
                            }
                            className={inputCls + " font-mono"}
              ...
              <Section title="G-code Pass Settings">
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setEnablePerPathPasses(e.currentTarget.checked)
                    }
